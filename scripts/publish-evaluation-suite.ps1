param(
    [string]$Path = (Join-Path $PSScriptRoot '..\evaluations\answer_suite.example.json'),
...
Invoke-RestMethod -Method Post -Uri "$BaseUri/api/v1/evaluations/suites" -Headers $headers -Body $bodyBytes |
